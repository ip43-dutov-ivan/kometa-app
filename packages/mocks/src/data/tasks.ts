...
export const tasks: Task[] = [
  {
    ...
    category: "education",
    location: { label: "Kyiv, KPI", isRemote: false, latitude: 50.4499, longitude: 30.4615 },
  ...
  },
  {
    ...
    category: "home_tech",
    location: { label: "Kyiv, Podil", isRemote: false, latitude: 50.465, longitude: 30.516 },
  ...
  },
  {
    ...
    category: "design",
    location: { label: "Remote", isRemote: true },
    compensation: { type: "money", amount: 300, currency: "UAH" },
    status: "completed",
    ownerId: "user-1",
  ...
  },
  {
    ...
    compensation: { type: "money", amount: 500, currency: "UAH" },
  ...
  },
  {
    ...
    category: "education",
    location: { label: "Remote", isRemote: true },
    compensation: { type: "money", amount: 280, currency: "UAH" },
    status: "inProgress",
    ownerId: "user-3",
  ...
  },
  {
    ...
    compensation: { type: "money", amount: 220, currency: "UAH" },
    status: "cancelled",
    ownerId: "user-1",
