...
import { getGeocoderTheme, type MapboxTheme } from "@/shared/lib/mapbox-geocoder-theme";
import { reverseGeocodeLocation } from "@/shared/lib/mapbox-geocoding";
import { getMapboxLanguage } from "@/shared/lib/mapbox-language";
import { LocationCoordinateFields } from "./location-coordinate-fields";
import { LocationMap } from "./location-map";
import { LocationRemoteToggle } from "./location-remote-toggle";
    ...
    <div className="grid min-w-0 max-w-full gap-3 overflow-hidden">
      ...
      <div className="grid min-w-0 max-w-full gap-3">
        ...
        {!value.isRemote && !MAPBOX_ACCESS_TOKEN ? (
          <LocationCoordinateFields value={value} disabled={disabled} onChange={onChange} />
        ) : null}
      </div>
    </div>
  );
